...
int main(int argc, char **argv) 
{
    ...
    //     cv::imwrite(data_path+"/data/snj/" + std::to_string(i) + "-ori_fig.png", HashReg_RefTLS->pointMat_vec_[i]); 
    ...
    //         }
    //     }
    //     cv::imwrite(data_path+"/data/snj/" + std::to_string(i) + "-filterd_fig.png", HashReg_RefTLS->pointMat_vec_[i]); 
    // }
